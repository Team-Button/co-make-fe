        ...
        <>
            <form className="mx-auto"  onSubmit={handleSubmit(onSubmit)}>
                <div className="add-form mx-auto form-group p-3 d-flex flex-column justify-content-center">
                    ...
                    <select name="category" className="form-control" id="category" ref={register({ required: true})}>
                        ...
                        <option value={1}>Illegal Activities</option>
                    </select>
                ...
                <button className="add-btn btn btn-primary pl-5 pr-5 m-3" >Add Post</button>
                </div>
